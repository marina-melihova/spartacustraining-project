 ...
 */
package com.epam.spartacustraining.commercewebservices.xstream;
...
public class XmlXStreamMarshallerFactoryTest
{
	...
	private static final String SERVICE_BEAN_DEF = "" + "<beans xmlns=\"http://www.springframework.org/schema/beans\"\n"//
			...
			+ "       <bean\n"//
			+ "             id=\"onlyOneInstance\"\n"//
			+ "             class=\"com.epam.spartacustraining.commercewebservices.xstream.XmlXStreamMarshallerFactory\">\n"//
			+ "       </bean>\n"//
			+ "</beans>";
