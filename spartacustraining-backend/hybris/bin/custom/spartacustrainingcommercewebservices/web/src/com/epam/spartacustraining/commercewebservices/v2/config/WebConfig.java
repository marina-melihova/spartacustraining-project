 ...
 */
package com.epam.spartacustraining.commercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.epam.spartacustraining.commercewebservices.constants.YcommercewebservicesConstants;
import com.epam.spartacustraining.commercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "spartacustrainingcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "spartacustrainingcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "spartacustrainingcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "spartacustrainingcommercewebservices.v2.description";
	private static final String TITLE = "spartacustrainingcommercewebservices.v2.title";
	private static final String VERSION = "spartacustrainingcommercewebservices.v2.version";
	private static final String LICENSE = "spartacustrainingcommercewebservices.v2.license";
	private static final String LICENSE_URL = "spartacustrainingcommercewebservices.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "spartacustrainingcommercewebservices.content.negotiation.legacy";
