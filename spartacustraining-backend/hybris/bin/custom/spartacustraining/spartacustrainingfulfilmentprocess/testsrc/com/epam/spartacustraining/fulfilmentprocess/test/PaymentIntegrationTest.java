...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		definitonFactory.add("classpath:/spartacustrainingfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/spartacustrainingfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/spartacustrainingfulfilmentprocess/test/testCatalog.csv", "windows-1252");
