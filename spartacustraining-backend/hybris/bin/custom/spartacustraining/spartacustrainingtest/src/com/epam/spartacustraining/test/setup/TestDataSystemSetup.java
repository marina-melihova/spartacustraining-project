 ...
 */
package com.epam.spartacustraining.test.setup;
...
import com.epam.spartacustraining.test.constants.SpartacustrainingTestConstants;
import com.epam.spartacustraining.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SpartacustrainingTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/spartacustrainingtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/spartacustrainingtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/spartacustrainingtest/import/cstickets.impex");
			...
			importImpexFile(context, "/spartacustrainingtest/import/csquotes.impex");
		}
	}
}
